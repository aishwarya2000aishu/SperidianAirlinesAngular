...
export class SearchComponent implements OnInit {
  ...
  public City = [{ name: 'Agartala' }, { name: 'Agra'}, 
  { name: 'Ahmedabad'},{ name: 'Aizwal' }, { name: 'Allahabad'}, { name: 'Amritsar'}, 
  ...
  ngOnInit(): void {
    ...
    this.searchdto.arrive=null;
    this.searchdto.depart=null;
  ...
  onDateSelect(e) {
   //resetting return date option from depart date
    //this.returnDate = e.target.value;
    //resetting selected return date to depart date
 ...
 // }
  ...
  searchFlights() {
    ...
    //toLocaleUpperCase returns the upper case of fclass
